...
The browser runs the engine locally—no request or cold start is needed for the interactive simulation. Seeded runs are reproducible across the web app, API, and CLI.
